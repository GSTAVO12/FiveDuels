getgenv().user_settings = {
   enabled = true,
   hitbox = 'Head', -- Change to 'Head' to lock onto player's head
...
runservice.PostSimulation:Connect(function()
   ...
   for _, player in next, players:GetChildren() do
       local humanoidrootpart = player.Character and player.Character:FindFirstChild(user_settings.hitbox) -- Use user_settings.hitbox instead of 'HumanoidRootPart'
